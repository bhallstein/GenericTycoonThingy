...
ptree Level::readLevel(std::string fileName) // This may be replaced by more centralised serialisation later
{
...
void Level::update() {
	...
	if (framecount++ == 10)
		createUnit(rand()%w, rand()%h);		// Create a new unit every so often
