...
W::Colour::T Furnishing::defaultColour;
W::Colour::T Furnishing::defaultHoverColour;
...
void Furnishing::finalizePlacement() {
	...
	using namespace W::EventType;
	eh->subscribeToEventType(LEVEL_LEFTMOUSEDOWN, new W::Callback(&Furnishing::receiveEvent, this));
	eh->subscribeToEventType(LEVEL_LEFTMOUSEUP, new W::Callback(&Furnishing::receiveEvent, this));
	eh->subscribeToEventType(LEVEL_RIGHTMOUSEDOWN, new W::Callback(&Furnishing::receiveEvent, this));
	eh->subscribeToEventType(LEVEL_RIGHTMOUSEUP, new W::Callback(&Furnishing::receiveEvent, this));
	eh->subscribeToEventType(LEVEL_MOUSEMOVE, new W::Callback(&Furnishing::receiveEvent, this));
}

W::Colour::T Furnishing::col() {
